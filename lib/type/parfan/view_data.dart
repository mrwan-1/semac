...
class VIEWDATAParfan extends StatefulWidget {
  const VIEWDATAParfan({super.key});

  @override
  State<VIEWDATAParfan> createState() => _VIEWDATAParfanState();
}

class _VIEWDATAParfanState extends State<VIEWDATAParfan> {
...
class FirestoreDB {
  ...
  Stream<List<Product>> getAllProducts() {
    return _firebaseFirestore.collection('parfan').snapshots().map((snapshot) {
